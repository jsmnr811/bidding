...
<body style="min-height: 100%;" class="" cz-shortcut-listen="true">
    ...
    <div class="container py-5 min-h-100 position-relative">
        ...
        {{-- @include('livewire.sidlan.ireap.placeholder.chart-1') --}}
                ...
                <div class="tile-container h-100 d-flex flex-column">
                    <div class="tile-title d-flex flex-column flex-lg-row row-gap-2 justify-content-between align-items-start"
                        ...
                        <span>
                            ...
                            I-BUILD Subprojects Currently in the Pipeline (Number of Subprojects by Status)
                        </span>
            ...
            <div class="col">
                ...
                <div class="tile-container h-100 d-flex flex-column">
                    <div class="tile-title d-flex flex-column flex-lg-row row-gap-2 justify-content-between align-items-start"
                        style="font-size: 1.2rem;">
                        <span>
                            I-BUILD Subprojects in the Pipeline (No. of Days in the Current Status)
                        </span>
                        <div class="d-flex flex-row gap-2 align-items-center small">
                            <div class="fw-normal">Show:</div>
                            <select name="" id="cbo-filter-pipeline-status-timeline"
                                class="form-select filter-dropdown pe-lg-5">
                                <option value="All">All</option>
                                <optgroup label="Clusterwide">
                                    <option value="Luzon A">Luzon A</option>
                    ...
                    <div class="tile-content position-relative overflow-hidden flex-grow-1 chart-container"
                        style="height: 400px;">
                        <canvas id="chrt-pipelined-by-status-timeline"
                            class="custom-chart position-absolute top-0 start-0 bottom-0 end-0" width="684"
                            height="600"
                            style="display: block; box-sizing: border-box; height: 300px; width: 342px;"></canvas>
                    </div>
            ...
            <div class="col">
                ...
                <div class="tile-container h-100 d-flex flex-column">
                    <div class="tile-title d-flex flex-column flex-lg-row row-gap-2 justify-content-between align-items-start"
                        style="font-size: 1.2rem;">
                        <span>
                            I-BUILD Subprojects Actual Pace in Pre-Implementantion (Actual Number of Days Incurred by
                            Status)
                        </span>
                        <div class="d-flex flex-row gap-2 align-items-center small">
                            <div class="fw-normal">Show:</div>
                            <select name="" id="cbo-filter-pipeline-status-pace"
                                class="form-select filter-dropdown pe-lg-5">
                                <option value="All">All</option>
                                <optgroup label="Clusterwide">
                                    <option value="Luzon A">Luzon A</option>
                    ...
                    <div class="tile-content position-relative overflow-hidden flex-grow-1 chart-container"
                        style="height: 400px;">
                        <canvas id="chrt-pipelined-by-status-pace"
                            class="position-absolute top-0 start-0 bottom-0 end-0" width="684" height="600"
                            style="display: block; box-sizing: border-box; height: 300px; width: 342px;"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col position-relative">
                <div class="tile-container position-relative">
                    <div class="tile-title d-flex flex-column flex-lg-row row-gap-2 justify-content-between align-items-start"
                        style="font-size: 1.2rem;">
                        <span>
                            I-BUILD Subprojects Already Beyond Procurement Timeline (Number of Subprojects)
                        </span>
